...
if ($_POST["module"] == "testEmail") {
  ...
  <html>
    ...
    <div class='background2' style='width: 70%; overflow-x: hidden; min-width: 300px; margin: 0 auto; position: relative; background: white;'>
      ...
      <h2 style='font-family: Oswald,  text-align: center; sans-serif; font-size: calc(1.2vw + 0em); position: relative; margin: 0 auto; letter-spacing: 0px; color: #664A99; margin-top: 1vw; text-align: center; '>We're glad to have you here</h2>
