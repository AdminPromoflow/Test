...
if ($_POST["module"] == "testEmail") {
  ...
  <html>
    ...
    <div class='background2' style='width: 70%; overflow-x: hidden; min-width: 300px; margin: 0 auto; position: relative; background: white;'>
      ...
      <h1 style='font-family: Oswald, sans-serif; font-size: calc(1.9vw + 0.3em); position: relative; margin: 0 auto; letter-spacing: 0px; color: #664A99; margin-top: 0.3vw; text-align: center; '>HELLO AND WELCOME TO LANYARDS FOR YOU</h1>
