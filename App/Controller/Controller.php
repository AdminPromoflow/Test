...
<html>
  ...
  <div class='background' style= 'position: relative; width: 100%; background: rgb(245,245,245); ' >
    ...
    <h1 style='font-family: Oswald, sans-serif; font-size: calc(2vw + 10px); background: green; min-width: 300; color: #664A99; margin-top: 25px; text-align: center; '>HELLO AND WELCOME TO LANYARDS FOR YOU</h1>
    </div>
  </div>
  </body>
</html>
