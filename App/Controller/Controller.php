...
if ($_POST["module"] == "testEmail") {
  ...
  <html>
    ...
    <div class='background2' style='width: 70%; overflow-x: hidden; min-width: 300px; margin: 0 auto; position: relative; background: white;'>
      ...
      <div class='header' style= 'position: relative; background: #555FA8; width: 100%; margin-top: calc(1.4vw + 0.4em);'>
        <img  alt='Imagen' style='display: block; width: calc(6.6vw + 1.1em); position: absolute; top: 1vw; left: 1vw; padding: 1vw 0;' src='https://lanyardsforyou.com/Pages/General/Menu/Logo.png'>
      </div>
